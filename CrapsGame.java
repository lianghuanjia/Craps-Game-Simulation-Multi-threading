...
public class CrapsGame {
	...
	private CrapsMetricsMonitor localMonitor;
	...
	boolean playGame(PrintWriter pw) 
		{
		int numOfDice = rollDice();
		pw.println("Rolled a " + numOfDice + " at " + getTime());
		numOfRolls += 1;
		if (numOfDice == 7 || numOfDice == 11) 
			...
			while(true) 
				...
				pw.println("Rolled a " + rollDice + " at " + getTime());
				numOfRolls += 1;
